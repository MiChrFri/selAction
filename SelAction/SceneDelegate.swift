...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
  ...
  func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
    ...
    let q = Question(title: "test", question: "asdas")
    let navigationController = UINavigationController(rootViewController: QuestionListViewController())
    

//    svc.showDetailViewController(navigationController, sender: nil)
      
    svc.viewControllers = [navigationController, QuestionViewController(with: q)]
